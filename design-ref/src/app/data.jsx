// MedTrack — seed data + domain helpers. App "today" = Sat 27 Jun 2026.

// supply thresholds: >14 healthy · 7–14 low · <7 critical
function supplyStatus(days) {
  if (days < 7) return "critical";
  if (days <= 14) return "low";
  return "healthy";
}
const STATUS_LABEL = { healthy: "Healthy supply", low: "Refill soon", critical: "Critical — refill on the way" };
...
const INITIAL = {
  ...
  meds: [
    {
      ...
      missedDays: [10], // index into 30-day calendar
    },
    {
  ...
  delivery: {
    active: {
      med: "Imatinib 400 mg", step: 1, // 0 dispatched · 1 in transit · 2 delivered
      eta: "Tomorrow · 28 Jun", window: "9:00 AM – 12:00 PM",
      agent: "Joseph K.", dispatchedOn: "26 Jun", ref: "MT-2026-0627-IMA",
...
const SKIP_REASONS = ["Forgot", "Side effects", "Ran out", "Other"];

window.MT = { INITIAL, FACILITIES, SKIP_REASONS, supplyStatus, STATUS_LABEL };
